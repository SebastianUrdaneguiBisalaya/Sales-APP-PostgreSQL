...
class IntroduceInformationInForm:
    ...
    # Creating the button
      ...
      #          border=1,font=("Inter", 12), relief="flat", cursor="hand2").place(x=505, y=599)
        Button(self.ventanasec, width=11, text="Enviar", bootstyle = "success",
               cursor="hand2").place(x=490, y=599)
    ...
    # Creating the main of secondary screen
      ...
      #         state="readonly", cursor="arrow", justify="center").place(x=190,y=211)
        ...
        order_date = DateEntry(self.label_frame_1, width=13, border=0, cursor="arrow",
        ...
        delivery_date = DateEntry(self.label_frame_1, width=13, border=0, cursor="arrow",
        ...
        Entry(self.label_frame_1, width=13, fg="black", border=0, font=("Inter", 11), bg="#D9D9D9", cursor="arrow",
              justify="center", textvariable=mode_delivery).pack(padx=14,pady=12, side="left")
        ...
        state = tk.StringVar()
        Entry(self.label_frame_3, width=8, fg="black", border=0, font=("Inter", 11), bg="#D9D9D9", cursor="arrow",
              justify="center", textvariable=state).pack(padx=6,pady=12, side="left")
      ...
      #   ).pack(padx=6,pady=12, side="left")
        ...
        Button(self.ventanasec, width=11, text = "Limpiar", bootstyle = "info",
               cursor="hand2", command=partial(delete_all_information, mode_delivery, customer_name, segment_customer, country, city, state, postal_code, region, product_name, info_category, subcategory_product)).place(x=730, y=599)
