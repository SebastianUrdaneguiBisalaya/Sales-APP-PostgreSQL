...
class RegisterForm:
    ...
    def __init__(self):
        ...
        absolute_image_path = os.path.join(absolute_folder_path, "./RegisterForm.png")
        ...
        full_name = Entry(self.ventana, width=36, fg = "black", bg = "#fcfcfc", font = ("Inter", 11), border=0, cursor="arrow")
        full_name.place(x=82, y = 410)
        Frame(self.ventana, width=309, height=2.5, bg="#EA7E7E").place(x=72, y= 435)
        
        full_name_company = Entry(self.ventana, width=36, fg = "black", bg = "#fcfcfc", font = ("Inter", 11), border=0, cursor="arrow")
        full_name_company.place(x=82, y = 470)
        Frame(self.ventana, width=309, height=2.5, bg="#EA7E7E").place(x=72, y= 495)
        
        full_name_user = Entry(self.ventana, width=36, fg = "black", bg = "#fcfcfc", font = ("Inter", 11), border=0, cursor="arrow")
        full_name_user.place(x=82, y = 534)
        Frame(self.ventana, width=309, height=2.5, bg="#EA7E7E").place(x=72, y= 560)
        
        full_password = Entry(self.ventana, width=36, fg = "black", bg = "#fcfcfc", font = ("Inter", 11), border=0, cursor="arrow", show="*")
